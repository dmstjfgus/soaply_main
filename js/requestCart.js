        ...
        <div class="cart-list">
            <div class="cart-frame">
              <div class="cart-image">
                <img src="/main_project/images/${list.cart_img}" alt="" />
              </div>
            </div>
            ...
            <div class="cart-price">
              ...
              <div class="sum">합계 : <em>${list.cart_price}</em>원</div>
            </div>
            <div class="cart-btns">
              <div class="common-btn remove-cart" id="btn-${list.cart_idx}" >상품삭제</div>
              <div class="common-btn">바로구매</div>
            </div>
        </div>
        `;
...
window.addEventListener("load", getCartList);
